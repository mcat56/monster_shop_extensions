...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'distinct_cities' do
      ...
      chain = @meg.items.create(name: "Chain", description: "It'll never break!", price: 40, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 22)
      order_1 = user.orders.create!(name: 'Meg', street: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, address: address_1) 
      order_2 = user.orders.create!(name: 'Brian', street: '123 Brian Ave', city: 'Denver', state: 'CO', zip: 17033, address: address_1) 
      order_3 = user.orders.create!(name: 'Dao', street: '123 Mike Ave', city: 'Denver', state: 'CO', zip: 17033, address: address_1) 
